...
class ClientUI(App):
    ...
    async def handle_message(self, message):
        ...
        try:
            ...
            #self.add_log(json.dumps(data, indent=2))
            ...
            # If the server still sends "It's your turn!" or other turn messages, you can ignore them 
            # or handle them. But it's best to rely on the current_player data from the game state.
    ...
    def update_hand(self, cards):
        ...
        for card in cards:
            ...
            card_box = BoxLayout(orientation='vertical', size_hint=(1, None), height=200, spacing=5)
            ...
            card_label = Label(text=f"{card_name}\nCost: {card['cost']}", halign='center', valign='middle')
